<div class="x_panel"> 
    <div class="x_content">    
        <?php echo $this->Form->create('Inspection', array('controller' => 'inspections', 'action' => 'product_transfer_lot_to_lot/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'transfer_product_one_lot_to_another')); ?>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <?php endforeach; ?>
                        <?php if($balance):?>
                        <tr>
                            <?php echo $this->Form->create('Inspection', array('controller' => 'inspections', 'action' => 'product_transfer_lot_to_lot/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'transfer_product_one_lot_to_another_save')); ?>
                        ...
                        <?php else:?>
                        <tr>
                            <td><td align="center" colspan="6"><strong><span style="color:red;">There is no Product for transfer</span></span></strong> </td></td>
                        </tr>
                        <?php endif;?>
                </tbody>
            </table>            
    ...
    <div class="x_content">
                <div role="alert" class="alert alert-success alert-dismissible fade in">
                    ...
                    <strong>There is no product found with your search filter options.Please try again.</strong>
                </div>
    </div>
       <?php endif; ?>
