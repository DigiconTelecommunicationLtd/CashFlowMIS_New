...
<div class="x_title">
    ...
    <div class="x_content">
        <?php echo $this->Form->create('Client', array('action' => 'edit', 'class' => 'form-horizontal form-label-left')); ?>
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3"> 
                <?php echo $this->Form->submit('save client', array('class' => 'btn btn-success')); ?>
