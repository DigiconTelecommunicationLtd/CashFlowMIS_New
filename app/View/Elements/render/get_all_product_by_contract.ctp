            ...
            <tbody>
                <?php foreach ($contractProducts as $contractProduct): ?>
                    <tr>
                        ...
                        <td><?php echo  h($contractProduct['ContractProduct']['unit_weight'] != 'N/A') ? h($contractProduct['ContractProduct']['unit_weight'] * $contractProduct['ContractProduct']['quantity']) . ' ' . $contractProduct['ContractProduct']['uom'] : 'N/A'; ?>&nbsp;</td>
