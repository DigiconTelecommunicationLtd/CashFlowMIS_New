...
<?php if ($this->Session->check('Message.flash')): ?>
    ...
    <?php if($inspection_results): ?>
        <div class="x_content">
            <table  class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <td colspan="9"style="text-align:center;font-weight: bold;color:#FFF;background-color:#2A3F54;">Delivery quantity & Date From::)</td>
                    </tr>
                     <?php echo $this->Form->create('Delivery', array('action' => 'add/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'DeliverySave')); ?>
                    <tr>
                        <td colspan="7" style="text-align:right;color:red;font-weight: bold">Actual Delivery Date[Y-M-D]</td>
                        <td colspan="2">
                <?php echo $this->Form->input("date", array("type" => "text", 'label' => false, 'div' => false, 'autocomplete'=>'off', 'class' => "form-control col-md-1 col-xs-12 single_cal3",'required'=>TRUE)) ?>
                    ...
                    <tr>
                        <td>Category</td>
                        <td>Product</td>                    
                        <td><a data-toggle="tooltip"  title="Inspection quantity">Ins. Qty</a></td>
                        <td><a data-toggle="tooltip"  title="Previous Delivery quantity">P.D.Qty</a></td>
                        <td>Balance.Qty</td>
                        <td>UOM</td>
                ...
                <tbody>           
                    ...
                    <tr>
                      ...
                      <?php } else{
                          ?>
                        <tr>
                            <td colspan="9" align="center"><strong><span style="color:red;">There is no remaining Delivery product against this PO.</span></strong></td>
                        </tr>
                     <?php
                      }?>
                </tbody>
    ...
    <?php else :
        ...
        <div role="alert" class="alert alert-success alert-dismissible fade in">
            ...
            <strong>There is no inspection with your search filter options.Please try again.</strong>
        </div>
    <?php endif; endif; ?>  
</div>
