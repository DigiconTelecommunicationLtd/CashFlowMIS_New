<div class="x_panel">
    <div class="x_title">
        <strong>PLI Report Details:</strong> 
    </div>
    <div class="x_content">        
        <?php echo $this->Form->create('Report', array('controller' =>'reports', 'action' =>'pli_report/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'Report')); ?>
            ...
            <tbody>
                ...
                foreach ($results as $result): ?>
                    <tr>
                        ...
                        <td><?php echo h($result['Delivery']['pli_qty']);$total_qty+=$result['Delivery']['pli_qty']; ?></td>
                        <td><?php echo h($result['Delivery']['uom']);$uom=$result['Delivery']['uom']; ?></td>
                        <td><?php echo ($result['Delivery']['unit_weight']); ?></td>
                        <td><?php echo is_numeric($result['Delivery']['unit_weight'])?$result['Delivery']['unit_weight']*$result['Delivery']['pli_qty']:'N/A';$total_weight+=is_numeric($result['Delivery']['unit_weight'])?$result['Delivery']['unit_weight']*$result['Delivery']['pli_qty']:0; ?></td>
                        <td><?php echo ($result['Delivery']['unit_weight_uom']);$unit_weight_uom=$result['Delivery']['unit_weight_uom']; ?></td>
                        <td><?php echo ($result['Delivery']['planned_delivery_date']!="0000-00-00")?$result['Delivery']['planned_delivery_date']:"N/A"; ?></td>
                        <td><?php echo ($result['Delivery']['actual_delivery_date']!="0000-00-00")?$result['Delivery']['actual_delivery_date']:"N/A"; ?></td>
                        <td><?php echo ($result['Delivery']['planned_pli_date']!="0000-00-00")?$result['Delivery']['planned_pli_date']:"N/A"; ?></td>
                        <td><?php echo ($result['Delivery']['actual_pli_date']!="0000-00-00")?$result['Delivery']['actual_pli_date']:"N/A"; ?></td>
                        <td><?php echo ($result['Delivery']['planned_date_of_pli_aproval']!="0000-00-00")?$result['Delivery']['planned_date_of_pli_aproval']:"N/A"; ?></td>
                        <td><?php echo ($result['Delivery']['actual_date_of_pli_aproval']!="0000-00-00")?$result['Delivery']['actual_date_of_pli_aproval']:"N/A"; ?></td>
                    </tr>
                <?php endforeach; ?>
                    <tr>
                        <td>Total:</td>
