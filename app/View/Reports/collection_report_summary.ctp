<div class="x_panel">
    <div class="x_content">
        ...
        <?php echo $this->Form->create('Report', array('controller' => 'reports', 'action' => 'collection_report_summary/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'Report', 'onsubmit' => "return validate();")); ?>
                ...
                if ($results):
                    ...
                    foreach ($results as $result):
                        ...
                        <tr>
                            ...
                            <td><?php echo $invoice_amount=h($result[0]['invoice_amount']); ?>&nbsp;</td>
                            <td><?php echo $total_collection=h($result[0]['total_collection']); ?>&nbsp;</td>
                            <td><?php echo $invoice_amount-$total_collection; ?>&nbsp;</td>
