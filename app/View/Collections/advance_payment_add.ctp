    ...
    <div class="x_content">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                 <?php echo $this->Form->hidden("collection_type", array("type" => "text", 'label' => false, 'div' => false, 'class' => "form-control col-md-7 col-xs-12", 'required' => 'required', 'id'=>'collection_type', 'value' =>'Advance')) ?>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <?php echo $this->Form->input("invoice_ref", array("type" => "text", 'label' => false, 'div' => false, 'class' => "form-control col-md-7 col-xs-12", 'required' => 'required', 'id' =>'invoice_ref_no')) ?>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php echo $this->Form->input("billing_percent", array("type" => "number", 'label' => false, 'div' => false, 'class' => "form-control col-md-7 col-xs-12", 'required' => 'required', 'id' =>'billing_percent','onchange'=>"InvoiceValueCalculation(this.value)",'value'=>$result['Contract']['billing_percent_adv'],'readOnly'=>true)) ?>
            </div>
        </div>
         <div class="item form-group">
        ...
        <?php foreach ($product_category as $value):
              $checkAlreadyPayment=ClassRegistry::init('Collection')->getCollectionCategoryByContract($contract_id,$value['ProductCategory']['id'],'Advance');
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" name="data[Collection][product_category_id][<?php echo $value['ProductCategory']['id'] ?>]" class="form-control col-md-7 col-xs-12" value="<?php echo (!$checkAlreadyPayment)?round(($result['Contract']['billing_percent_adv']*$value[0]['amount'])/100,2):''; ?>" style="border-color: green" step="any"/>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <?php echo'Adv.'.$result['Contract']['billing_percent_adv'].'% X PO Product Value '.$value[0]['amount'] ; ?>
            </div>
        </div>
        <?php endforeach;?>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php
                 ...
                 $planned_submission_date = strtotime($result['Contract']['contract_date']) + $result['Contract']['invoice_submission_adv'] * 86400;
                 ...
                 $planned_payment_certificate_or_cheque_collection_date=strtotime($planned_submission_date)+$result['Contract']['payment_cheque_collection_adv'] * 86400;
                 ...
                 $planned_payment_collection_date=  strtotime($planned_payment_certificate_or_cheque_collection_date)+$result['Contract']['payment_credited_to_bank_adv'] * 86400;
