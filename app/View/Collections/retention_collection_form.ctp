<div class="x_panel">
    <div class="x_title">
        <h2>Retention Payment:</h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <?php echo $this->Form->create('Collection', array('action' => 'retention_payment_add/ ', 'class' => 'form-horizontal form-label-left', 'id' => 'Collection')); ?>
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Retention<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php echo $this->Form->input("collection_type", array("type" => "select", 'label' => false, 'div' => false, 'class' => "select2_single form-control", 'required' => 'required', 'tabindex' => -1, 'empty' => '','id'=>'collection_type','options'=>$collection_types)) ?>
            </div>
        </div>
        <div class="item form-group">
