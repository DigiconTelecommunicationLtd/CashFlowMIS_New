<div class="x_panel">
    <div class="x_title">
        ...
        <ul class="nav navbar-right panel_toolbox">                      
            <li><a href="<?php echo $this->Html->url('/product_categories/'); ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i></a>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <?php echo $this->Form->create('ProductCategory', array('action' => 'edit', 'class' => 'form-horizontal form-label-left')); ?>
