<div class="x_panel">
    ...
    <div class="x_content">
        <?php echo $this->Form->create('Product', array('action' => 'edit', 'class' => 'form-horizontal form-label-left')); ?>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <?php echo $this->Form->input("product_category_id", array("type" => "select", 'label' => false, 'div' => false, 'class' => "select2_single form-control", 'required' => 'required','tabindex'=>-1)) ?>
            </div>
        </div>
