<div class="x_panel">
    ...
    <div class="x_content">
        <?php echo $this->Form->create('User', array('action' => 'addUser', 'class' => 'form-horizontal form-label-left')); ?>
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alias">Password <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
