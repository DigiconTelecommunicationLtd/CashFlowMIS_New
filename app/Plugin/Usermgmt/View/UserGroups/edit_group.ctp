<div class="x_panel">
    <div class="x_title">
        <span class="fa fa-user">&nbsp;<strong>Group Edit:</strong></span>
    ...
    <div class="x_content">
        <?php echo $this->Form->create('UserGroup', array('action' => 'editGroup', 'class' => 'form-horizontal form-label-left','method'=>'post')); ?>
